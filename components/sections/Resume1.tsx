					...
					<div className="row mt-6">
							...
							<div className="resume-card p-lg-6 p-4 mb-lg-0 mb-6">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>MSc, Data Science</h5>
												<p className="text-300 mb-0">Manchester Metropolitan University</p>
											</div>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Applied Data Science</h5>
												<p className="text-300 mb-0">World Quant University</p>
											</div>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2016-2020</p>
												<h5>Actuarial Science</h5>
												<p className="text-300 mb-0">University of Lagos</p>
											</div>
											{/* <h3 className="text-linear-1 ms-auto fw-semibold">4.9<span className="fs-4 fw-bold">/5</span></h3> */}
										</div>
									</div>
						...
						<div className="col-lg-6 col-12">
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">May 2024 – Present</p>
										<h5>Research Data Scientist</h5>
										<p className="text-300 mb-0">The Rosalind Franklin Institute, Oxford</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">September 2023 – April 2024
</p>
										<h5>Machine Learning Engineer</h5>
										<p className="text-300 mb-0">Self Development, United Kingdom</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">June 2023 – September 2023</p>
										<h5>Deep Learning Engineer</h5>
										<p className="text-300 mb-0">Manchester Metropolitan University, Manchester</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-4">
										<p className="fw-extra-bold text-linear-1 mb-2">July 2023 – August 2023</p>
										<h5>Research Data Scientist - Intern</h5>
										<p className="text-300 mb-0">The Rosalind Franklin Institute, Oxford</p>
									</div>
								</div>
							</div>
