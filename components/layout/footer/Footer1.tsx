...
export default function Footer1() {
	return (
		<>
			<footer>
				<div className="section-footer position-relative pt-6 pb-6 bg-secondary-1">
					<div className="container position-relative z-1">
						<div className="text-center">
							<Link className="d-flex main-logo align-items-center d-inline-flex" href="/">
								...
								<span className="fs-4 ms-2 text-white-keep">adedolapo.</span>
							</Link>
						...
						<div className="row text-center py-4">
							<span className="fs-6 text-white-keep">© {new Date().getFullYear()} All Rights Reserved by <span><Link href="" className="text-primary-1">Adedolapo Adebo</Link></span>
							</span></div>
					</div>
